...
import { assertBpmnElementIsMessageBoundaryEvent } from '../../BpmnElementTypeAssertionFunctions';
import {
  ...
  return (
    <Pane>
      <PaneHeader studio={studio} title={getPaneTitle()} paneId={props.paneId} collapsed={props.collapsed}>
        <PaneHeaderHelpIcon studio={studio} id="bpmn/properties/message_boundary_event" />
      </PaneHeader>
...
function PaneContent(props: PaneComponentProps): React.JSX.Element | null {
  ...
  return <PropertiesMessageBoundaryEvent key={getKeyForPropertiesPane(selection)} {...props} />;
}

function PropertiesMessageBoundaryEvent(props: PaneComponentProps): React.JSX.Element {
  ...
  assertBpmnElementIsMessageBoundaryEvent(element);
