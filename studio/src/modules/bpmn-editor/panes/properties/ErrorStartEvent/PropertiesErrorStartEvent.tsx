...
import type { BpmnElement_ErrorStartEvent } from '@evil/bifrost_fw_sdk/types/bpmn/BpmnElementTypes';
...
type ErrorEventPropertiesRendererProps = {
  element: BpmnElement_ErrorStartEvent;
  ...
  return (
    <Pane>
      <PaneHeader studio={props.studio} title={getPaneTitle()} paneId={props.paneId} collapsed={props.collapsed}>
        <PaneHeaderHelpIcon studio={props.studio} id="bpmn/properties/error_start_event" />
      </PaneHeader>
...
function shouldBeDisplayed(editorDocument: EditorDocument, editorDocumentModel: any): boolean {
  return shouldBeDisplayedForBpmnElementOfType(editorDocument, editorDocumentModel, BpmnElementType.ErrorStartEvent);
}
...
function PaneContent(props: PaneComponentProps): React.JSX.Element | null {
  ...
  return <PropertiesErrorStartEvent key={getKeyForPropertiesPane(selection)} {...props} />;
}

function PropertiesErrorStartEvent(props: PaneComponentProps): React.JSX.Element {
  const bpmnDocumentModel: BpmnDocumentModel = props.editorDocumentModel;
  const element = bpmnDocumentModel.selection.getOnlyElementOrNull();
  assertBpmnElementIsErrorStartEvent(element);
      ...
      <PaneBody>
        <fieldset className="form-group d-flex flex-column">
          <div className="form-check form-check-inline">
            <input
              type="radio"
              id="error-start-event-match-all-errors"
            ...
            />
            <label className="form-check-label" htmlFor="error-start-event-match-all-errors">
              Match all errors
            </label>
          </div>
          <div className="form-check form-check-inline">
            <input
              type="radio"
              id="error-start-event-match-a-specific-error"
              className="form-check-input"
              name="optionsRadios"
              defaultChecked={!this.matchAllErrors()}
              onClick={() => matchAllErrorsChanged(false)}
              data-test--error-start-event-specific-error-radio
            />
            <label className="form-check-label" htmlFor="error-start-event-match-a-specific-error">
        ...
        {!this.state.matchAllErrors && (
          <fieldset>
            <PaneProperty
              ...
              htmlId="error-start-event-code-property"
            ...
            <PaneProperty
              label="Error Message"
              type="text-with-suggestions"
              htmlId="error-start-event-message-property"
