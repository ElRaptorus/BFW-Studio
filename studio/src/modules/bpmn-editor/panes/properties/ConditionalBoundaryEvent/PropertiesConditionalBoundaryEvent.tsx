...
import { assertBpmnElementIsConditionalBoundaryEvent } from '../../BpmnElementTypeAssertionFunctions';
import {
...
function getPaneTitle(): string {
  return 'Conditional Boundary Event';
}
  ...
  return (
    <Pane>
      <PaneHeader studio={props.studio} title={getPaneTitle()} paneId={props.paneId} collapsed={props.collapsed}>
        <PaneHeaderHelpIcon studio={props.studio} id="bpmn/properties/conditional_boundary_event" />
      </PaneHeader>
...
function PaneContent(props: PaneComponentProps): React.JSX.Element | null {
  ...
  return <PropertiesConditionalBoundaryEvent key={getKeyForPropertiesPane(selection)} {...props} />;
}

function PropertiesConditionalBoundaryEvent(props: PaneComponentProps): React.JSX.Element {
  ...
  assertBpmnElementIsConditionalBoundaryEvent(element);
    ...
    <PaneBody>
      <div className="form-group">
        <label className="d-block" style={{ width: '100%' }}>
          ...
          <span className="float-right">
            ...
            <OpenInNewTabButton
              ...
              dataTest="open-conditional-boundary-event-condition-new-tab"
            />
          </span>{' '}
        </label>
        ...
        <FeelEditor
          ...
          htmlAttributes={{ 'data-test--conditional-boundary-event-condition': true }}
        />
      </div>
    </PaneBody>
  );
