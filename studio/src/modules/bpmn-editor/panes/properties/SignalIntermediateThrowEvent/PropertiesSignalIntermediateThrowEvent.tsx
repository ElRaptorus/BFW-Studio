...
import { assertBpmnElementIsSignalIntermediateThrowEvent } from '../../BpmnElementTypeAssertionFunctions';
import {
...
function getPaneTitle(): string {
  return 'Signal Intermediate Throw Event';
}
  ...
  return (
    <Pane>
      <PaneHeader studio={studio} title={getPaneTitle()} paneId={props.paneId} collapsed={props.collapsed}>
        <PaneHeaderHelpIcon studio={studio} id="bpmn/properties/signal_intermediate_throw_event" />
      </PaneHeader>
...
function PaneContent(props: PaneComponentProps): React.JSX.Element | null {
  ...
  return <PropertiesSignalIntermediateThrowEvent key={getKeyForPropertiesPane(selection)} {...props} />;
}

function PropertiesSignalIntermediateThrowEvent(props: PaneComponentProps): React.JSX.Element {
  ...
  assertBpmnElementIsSignalIntermediateThrowEvent(element);
