...
import type { EditorDocument, PaneComponentProps, PaneProvider, PropertyValidationResult } from '@evil/bifrost_fw_sdk';
import {
  BpmnElementType,
  Pane,
  PaneBody,
...
import type { BpmnElement_Definition } from '@evil/bifrost_fw_sdk/types/bpmn/BpmnElementTypes';
