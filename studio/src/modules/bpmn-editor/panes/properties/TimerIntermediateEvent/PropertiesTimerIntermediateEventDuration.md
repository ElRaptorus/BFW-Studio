...
# Intermediate Duration Timer Catch Events

A `Intermediate Duration Timer Catch Event` will continue the process, after the configured duration timer has expired.
