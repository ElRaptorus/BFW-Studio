...
import { assertBpmnElementIsLinkIntermediateThrowEvent } from '../../BpmnElementTypeAssertionFunctions';
import {
...
function getPaneTitle(): string {
  return 'Link Intermediate Throw Event';
}
...
function shouldBeDisplayed(editorDocument: EditorDocument, editorDocumentModel: any): boolean {
  return shouldBeDisplayedForBpmnElementOfType(
    editorDocument,
    editorDocumentModel,
    BpmnElementType.LinkIntermediateThrowEvent,
  );
}
...
function PaneContent(props: PaneComponentProps): React.JSX.Element | null {
  ...
  return <PropertiesLinkIntermediateThrowEvent key={getKeyForPropertiesPane(selection)} {...props} />;
}

function PropertiesLinkIntermediateThrowEvent(props: PaneComponentProps): React.JSX.Element {
  ...
  assertBpmnElementIsLinkIntermediateThrowEvent(element);
