...
import { assertBpmnElementIsSignalStartEvent } from '../../BpmnElementTypeAssertionFunctions';
import {
  ...
  return (
    <Pane>
      <PaneHeader studio={studio} title={getPaneTitle()} paneId={props.paneId} collapsed={props.collapsed}>
        <PaneHeaderHelpIcon studio={studio} id="bpmn/properties/signal_start_event" />
      </PaneHeader>
...
function shouldBeDisplayed(editorDocument: EditorDocument, editorDocumentModel: any): boolean {
  return shouldBeDisplayedForBpmnElementOfType(editorDocument, editorDocumentModel, BpmnElementType.SignalStartEvent);
}
...
function PaneContent(props: PaneComponentProps): React.JSX.Element | null {
  ...
  return <PropertiesSignalStartEvent key={getKeyForPropertiesPane(selection)} {...props} />;
}

function PropertiesSignalStartEvent(props: PaneComponentProps): React.JSX.Element {
  ...
  assertBpmnElementIsSignalStartEvent(element);
