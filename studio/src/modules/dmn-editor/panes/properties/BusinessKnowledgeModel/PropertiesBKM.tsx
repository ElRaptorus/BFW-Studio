...
function shouldBeDisplayed(editorDocument: EditorDocument, editorDocumentModel: EditorDocumentModel): boolean {
  return shouldBeDisplayedForDmnDrdElementOfType(
    editorDocument,
    editorDocumentModel,
    DmnElementType.BusinessKnowledgeModel,
  );
}
  ...
  return (
    <PaneBody>
      <PaneProperty
        ...
        htmlAttributes={{ 'data-test--dmn-bkm-name': true }}
      />
      <PaneProperty
        label="ID"
        type="text"
        ...
        htmlAttributes={{ 'data-test--dmn-bkm-id': true }}
      />
      <PaneProperty
