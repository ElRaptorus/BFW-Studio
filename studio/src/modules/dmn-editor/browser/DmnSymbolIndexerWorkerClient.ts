...
export class DmnSymbolIndexerWorkerClient extends AbstractWorkerClient {
  constructor() {
    const worker = new Worker(
      /* webpackChunkName: "DmnSymbolIndexerWorker" */ new URL(
        '../webworker/DmnSymbolIndexerWorker.ts',
        import.meta.url,
      ),
    );
    super(worker);
