...
import type { DmnSanitizableIssue, DmnSanitizerIssueSeverity } from './sanitizerTypes';

export type SanitizerBadgeProps = {
  findings: DmnSanitizableIssue[];
  onShowInInspector: () => void;
};

function worstSeverity(findings: DmnSanitizableIssue[]): DmnSanitizerIssueSeverity {
...
const SEVERITY_ICON: Record<DmnSanitizerIssueSeverity, string> = {
  error: 'ph ph-warning',
  warning: 'ph ph-warning',
  info: 'ph ph-info',
};

const SEVERITY_CSS: Record<DmnSanitizerIssueSeverity, string> = {
